...
void DSPEditorSection::setupDockLayout()
{
    ...
    // === Configure layout ===
    // Split left side (spectrum+dsp) and right side (preview+controls) horizontally
    splitDockWidget(spectrumDock, previewDock, Qt::Horizontal);
    ...
    // Set size ratios - left:right = 50:50
    QList<QDockWidget*> horizDocks = {spectrumDock, previewDock};
    QList<int> horizSizes = {500, 500};
